...
function create_rider(entry)
{
    ...
    return {
        Name: entry.Rider1_name,
        ID: +entry.RiderID,  // parse the RiderID as a number
        Races: entry.RaceName,
        Years: +entry.Year, // parse the Year as a number
